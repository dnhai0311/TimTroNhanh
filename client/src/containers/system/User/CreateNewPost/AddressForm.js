...
import { apiAllGetProvinces, apiGetAllDistricts } from '../../../../services/app';
...
const AddressForm = ({
    ...
    useEffect(() => {
        setExactlyAddress(
            `${
                districtSelected && districtSelected.value && provinceSelected && provinceSelected.value
    ...
    return (
        <>
            ...
            <div className="d-flex mt-3 flex-wrap">
                ...
                <InputPost name={'Địa chỉ chính xác'} isDisable={true} value={exactlyAddress || ''} />
            </div>
        </>
    );
};
