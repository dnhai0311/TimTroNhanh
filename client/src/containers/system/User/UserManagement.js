...
const UserManagement = () => {
    ...
    return (
        <>
            ...
            <Form className="w-md-75 w-lg-50 m-auto" onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-3 d-flex">
                    ...
                    <div>
                        ...
                        <Form.Control type="file" className="mt-3" onChange={handlePreviewAvatar} />
                    </div>
                </Form.Group>

                <Button variant="primary" type="submit" className="w-100 mb-3" id="submitButton">
